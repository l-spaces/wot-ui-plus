...
export function formatArray(
  ...
  const result: Array<Array<ColumnItem>> = (tempArray as Array<Array<string | number | ColumnItem>>).map((col) => {
    return col.map((row) => {
       ...
       */
      if (!Object.prototype.hasOwnProperty.call(row, valueKey) && !Object.prototype.hasOwnProperty.call(row, labelKey)) {
        throw Error('Can not find valueKey and labelKey in columns')
      }
