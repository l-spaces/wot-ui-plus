...
export const lazyLoadProps = {
  ...
  // 图片裁剪模式
  mode: {
    type: String as PropType<ImgMode>,
    default: 'widthFix'
  },
  // 占位图片路径
  loadingImg: {
