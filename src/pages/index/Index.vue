<template>
  <view class="page">
    <view class="page__hd">
      ...
      <view class="page__desc">wot - ui</view>
    </view>
    <view class="page__bd">
      <view v-for="(page, j) in list" :key="j" is-link :label="page.name">
        <view class="wd-cell__title" @click="handleClick(`/subPages/${page.id}/Index`)">{{ page.name }}</view>
      </view>
    </view>
  </view>
</template>
