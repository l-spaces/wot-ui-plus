<template>
  <view class="wd-page">
    ...
    <demo-block title="自定义字段名">
      <wd-tree :data="customFieldData" :default-expanded-keys="['1', '1-1']" key-field="key" label-field="name" children-field="items" selectable />
    </demo-block>
