<template>
  <page-wraper show-dark-mode>
    ...
    <demo-block title="文字颜色">
      <view class="color-box">
        <view class="color-item" style="background: #303133" @click="handleClick('#303133')">
          <text class="color-title">主要文字</text>
          <text class="color-value">#303133</text>
        </view>
        <view class="color-item" style="background: #606266" @click="handleClick('#606266')">
          <text class="color-title">常规文字</text>
          <text class="color-value">#606266</text>
        </view>
        <view class="color-item" style="background: #909399" @click="handleClick('#909399')">
          <text class="color-title">次要文字</text>
          <text class="color-value">#909399</text>
        </view>
        <view class="color-item" style="background: #a8abb2" @click="handleClick('#a8abb2')">
          <text class="color-title">占位文字</text>
          <text class="color-value">#a8abb2</text>
        </view>
