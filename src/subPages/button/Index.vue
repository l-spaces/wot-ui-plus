  ...
  <page-wraper>
    <view class="page-button">
      ...
      <demo-block title="幽灵按钮">
        ...
        <wd-button :round="false" plain>主要按钮</wd-button>
      </demo-block>
      <demo-block title="细边框幽灵按钮">
        ...
        <wd-button :round="false" plain hairline>主要按钮</wd-button>
      </demo-block>
      <demo-block title="幽灵按钮禁用状态">
        ...
        <wd-button :round="false" plain disabled>主要按钮</wd-button>
      </demo-block>
      <demo-block title="按钮大小">
        ...
        <wd-divider />
        <wd-button :round="false" size="small">小型按钮</wd-button>
        <wd-button :round="false" size="medium">普通按钮</wd-button>
        <wd-button :round="false" size="large">大型按钮</wd-button>
      </demo-block>
      ...
      <demo-block title="带图标的基本按钮">
        ...
        <wd-button class-prefix="fish" icon="refresh-circle">可回收</wd-button>
