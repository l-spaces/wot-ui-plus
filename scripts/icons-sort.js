/**
 * @fileoverview 图标名称智能排序脚本
 * @description
 * 本文件是 wot-ui-plus 项目中的图标名称排序脚本，用于对图标文档中的图标名称进行智能排序。
 * 该脚本通过自定义排序算法，按照语义化的规则对图标名称进行两级排序，确保图标文档的
 * 可读性和维护性。排序规则首先按连字符前的第一个单词分组，然后在组内按完整名称排序。
 *
 */
