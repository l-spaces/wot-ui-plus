...
以下是关于向 Wot UI Plus 提交反馈或代码的指南。在向 Wot UI Plus 提交 issue 或者 PR 之前，请先花几分钟时间阅读以下内容。
...
- 请先 [fork](https://github.com/l-spaces/wot-ui-plus.git) 一份组件库源码到自己的 github。
...
```bash
git clone https://github.com/l-spaces/wot-ui-plus.git
```
...
组件props、events、methods、slots添加规范注释
...
commit 描述说明了本次提交的具体描述，具体内容视情况而定，无固定规范。
