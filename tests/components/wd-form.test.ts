...
import WdFormItem from '@/uni_modules/wot-ui-plus/components/wd-form-item/wd-form-item.vue'
import WdInput from '@/uni_modules/wot-ui-plus/components/wd-input/wd-input.vue'
import WdCalendar from '@/uni_modules/wot-ui-plus/components/wd-calendar/wd-calendar.vue'
...
import WdPicker from '@/uni_modules/wot-ui-plus/components/wd-picker/wd-picker.vue'
import WdSelectPicker from '@/uni_modules/wot-ui-plus/components/wd-select-picker/wd-select-picker.vue'
import WdTextarea from '@/uni_modules/wot-ui-plus/components/wd-textarea/wd-textarea.vue'
import WdCheckbox from '@/uni_modules/wot-ui-plus/components/wd-checkbox/wd-checkbox.vue'
import WdCheckboxGroup from '@/uni_modules/wot-ui-plus/components/wd-checkbox-group/wd-checkbox-group.vue'
import WdSearch from '@/uni_modules/wot-ui-plus/components/wd-search/wd-search.vue'
...
import WdTag from '@/uni_modules/wot-ui-plus/components/wd-tag/wd-tag.vue'
import WdIcon from '@/uni_modules/wot-ui-plus/components/wd-icon/wd-icon.vue'
import { describe, test, expect, vi } from 'vitest'
import { nextTick } from 'vue'
import type { FormRules } from '@/uni_modules/wot-ui-plus/components/wd-form/types'
