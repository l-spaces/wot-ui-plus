...
import type { DirectionType, IndicatorPositionType } from '@/uni_modules/wot-ui-plus/components/wd-swiper/types'
import type { SwiperIndicatorType } from '@/uni_modules/wot-ui-plus/components/wd-swiper-nav/types'
