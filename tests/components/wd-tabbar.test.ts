...
import WdTabbar from '@/uni_modules/wot-ui-plus/components/wd-tabbar/wd-tabbar.vue'
import WdTabbarItem from '@/uni_modules/wot-ui-plus/components/wd-tabbar-item/wd-tabbar-item.vue'
