...
import WdSkeleton from '@/uni_modules/wot-ui-plus/components/wd-skeleton/wd-skeleton.vue'
import { describe, test, expect } from 'vitest'
import type { SkeletonRowCol, SkeletonTheme } from '@/uni_modules/wot-ui-plus/components/wd-skeleton/types'
