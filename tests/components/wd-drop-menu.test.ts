...
import WdDropMenu from '@/uni_modules/wot-ui-plus/components/wd-drop-menu/wd-drop-menu.vue'
import WdDropMenuItem from '@/uni_modules/wot-ui-plus/components/wd-drop-menu-item/wd-drop-menu-item.vue'
