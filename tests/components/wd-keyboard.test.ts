...
import WdKey from '@/uni_modules/wot-ui-plus/components/wd-keyboard/key/index.vue'
import WdKeyboard from '@/uni_modules/wot-ui-plus/components/wd-keyboard/wd-keyboard.vue'
