...
import WdNotify from '@/uni_modules/wot-ui-plus/components/wd-notify/wd-notify.vue'
import { describe, test, expect, vi, beforeEach } from 'vitest'
import { type NotifyPosition, type NotifyType } from '@/uni_modules/wot-ui-plus/components/wd-notify/types'
