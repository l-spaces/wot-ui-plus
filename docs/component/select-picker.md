...
| ---------------------- | --------------------------------------------------------------------------------------- | --------------------------- | -------------- | -------- | -------- |
| v-model                | 选中项，`type`为`checkbox`时类型为 array；`type`为`radio`时类型为 number/boolean/string | array/number/boolean/string | -              | -        | -        |
...
| select-size            | picker 内部选项组尺寸                                                                   | string                      | large          | -        | -        |
| min                    | 最小选中数量（仅 checkbox）                                                             | number                      | -              | 0        | -        |
| max                    | 最大选中数量（0 为无限，仅 checkbox）                                                   | number                      | -              | 0        | -        |
...
| safe-area-inset-bottom | 底部安全距离（iPhone X 类机型）                                                         | boolean                     | -              | true     | -        |
...
| show-confirm           | 是否显示确认按钮（仅 radio）                                                            | boolean                     | -              | true     | 1.2.8    |
| prop                   | 表单域 model 字段名（校验必填）                                                         | string                      | -              | -        | -        |
| rules                  | 表单验证规则（配合 wd-form）                                                            | `FormItemRule[]`            | -              | `[]`     | -        |
| clearable              | 显示清空按钮                                                                            | boolean                     | -              | false    | 1.11.0   |
| root-portal            | 脱离页面解决 fixed 失效问题                                                             | boolean                     | -              | false    | 1.11.0   |
