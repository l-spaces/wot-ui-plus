...
<wd-tabbar v-model="tabbar">
  ...
  <wd-tabbar-item :value="2" icon="cart" title="分类">
    <template #icon>
      <wd-img round height="40rpx" width="40rpx" src="https://wot-ui-plus.cn/assets/panda.jpg"></wd-img>
    </template>
  </wd-tabbar-item>
...
| zIndex                | tabbar 组件的层级                                  | number          | -                   | 500       | 0.1.27   |

## Events

| 事件名称 | 说明                  | 参数        | 最低版本 |
| -------- | --------------------- | ----------- | -------- |
| change   | tabbar 标签切换时触发 | `{ value }` | 0.1.27   |
