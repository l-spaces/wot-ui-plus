...
- **H5 端**：使用 Vue 3 的 teleport 特性
- **APP 端**：使用 renderjs 将元素移动到 uni-app 根节点
...
| transition             | 动画类型，参见 wd-transition 组件的 name            | string           | fade / fade-up / fade-down / fade-left / fade-right / slide-up / slide-down / slide-left / slide-right / zoom-in | -       | -        |
